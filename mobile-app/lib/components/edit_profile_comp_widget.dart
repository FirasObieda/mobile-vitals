...
import 'edit_profile_comp_model.dart';
export 'edit_profile_comp_model.dart';

class EditProfileCompWidget extends StatefulWidget {
  const EditProfileCompWidget({
    super.key,
    String? title,
  ...
  @override
  State<EditProfileCompWidget> createState() => _EditProfileCompWidgetState();
}

class _EditProfileCompWidgetState extends State<EditProfileCompWidget> {
  late EditProfileCompModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EditProfileCompModel());
    ...
    _model.conditionTextController ??= TextEditingController(
      ...
      valueOrDefault(currentUserDocument?.condition, ''),
      'No condition',
    ));
                        ...
                        Padding(
                          ...
                          child: ClipRRect(
                            ...
                            child: CachedNetworkImage(
                              fadeInDuration: Duration(milliseconds: 200),
                              fadeOutDuration: Duration(milliseconds: 200),
                              imageUrl: _model.uploadedFileUrl_uploadData9ss,
                              width: 300.0,
                              height: 200.0,
                              fit: BoxFit.cover,
                            ),
                ...
                child: FFButtonWidget(
                  onPressed: () async {
                    ...
                    if (selectedMedia != null &&
                      ...
                      safeSetState(
                          () => _model.isDataUploading_uploadData9ss = true);
                      ...
                      try {
                        ...
                        _model.isDataUploading_uploadData9ss = false;
                      }
                      if (selectedUploadedFiles.length ==
                              selectedMedia.length &&
                          downloadUrls.length == selectedMedia.length) {
                        safeSetState(() {
                          _model.uploadedLocalFile_uploadData9ss =
                              selectedUploadedFiles.first;
                          _model.uploadedFileUrl_uploadData9ss =
                              downloadUrls.first;
                        });
                ...
                child: FFButtonWidget(
                  onPressed: () async {
                    ...
                    await currentUserReference!.update(createUsersRecordData(
                      photoUrl: _model.uploadedFileUrl_uploadData9ss != ''
                          ? _model.uploadedFileUrl_uploadData9ss
                          : currentUserPhoto,
