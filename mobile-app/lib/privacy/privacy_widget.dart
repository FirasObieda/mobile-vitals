                  ...
                  child: Column(
                    ...
                    children: [
                      FFButtonWidget(
                        onPressed: () async {
                          context.pushNamed(
                            DataCollectionUsageWidget.routeName,
                      ...
                      FFButtonWidget(
                        onPressed: () async {
                          context.pushNamed(
                            SecurityPracticesWidget.routeName,
                            extra: <String, dynamic>{
                              kTransitionInfoKey: TransitionInfo(
                                hasTransition: true,
                                transitionType: PageTransitionType.rightToLeft,
                      ...
                      FFButtonWidget(
                        onPressed: () async {
                          context.pushNamed(
                            RegulatoryComplianceWidget.routeName,
                            extra: <String, dynamic>{
                              kTransitionInfoKey: TransitionInfo(
                                hasTransition: true,
                                transitionType: PageTransitionType.rightToLeft,
