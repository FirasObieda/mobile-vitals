...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: RegulatoryComplianceWidget.routeName,
          path: RegulatoryComplianceWidget.routePath,
          builder: (context, params) => RegulatoryComplianceWidget(),
        ),
        FFRoute(
          name: DataCollectionUsageWidget.routeName,
          path: DataCollectionUsageWidget.routePath,
          builder: (context, params) => DataCollectionUsageWidget(),
        ),
        FFRoute(
          name: DataSharingWidget.routeName,
          path: DataSharingWidget.routePath,
          builder: (context, params) => DataSharingWidget(),
        ),
        FFRoute(
          name: UserControlWidget.routeName,
          path: UserControlWidget.routePath,
          builder: (context, params) => UserControlWidget(),
        ),
        FFRoute(
          name: SecurityPracticesWidget.routeName,
          path: SecurityPracticesWidget.routePath,
          builder: (context, params) => SecurityPracticesWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
          name: BluetoothPageWidget.routeName,
          path: BluetoothPageWidget.routePath,
          requireAuth: true,
        ...
        FFRoute(
          name: PPGTestWidget.routeName,
          path: PPGTestWidget.routePath,
          requireAuth: true,
          builder: (context, params) => PPGTestWidget(),
        ),
        FFRoute(
          name: PPGDebugWidget.routeName,
          path: PPGDebugWidget.routePath,
          requireAuth: true,
          builder: (context, params) => PPGDebugWidget(),
        )
